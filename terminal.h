...
{
 WRONG_DATE=1, EXPIRED_CARD, INVALID_CARD, INVALID_AMOUNT, EXCEED_MAX_AMOUNT, INVALID_MAX_AMOUNT
}EN_terminalError_t;
...
extern EN_terminalError_t isValidCardPAN(ST_cardData_t* cardData);
...
extern EN_terminalError_t setMaxAmount(ST_terminalData_t* termData);
